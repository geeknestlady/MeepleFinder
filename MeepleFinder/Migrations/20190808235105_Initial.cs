...
namespace MeepleFinder.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mechanism", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Mechanism_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayAgain = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameRatings_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameRatings_Person_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameRatings_GamesId",
                table: "GameRatings",
                column: "GamesId");

            migrationBuilder.CreateIndex(
                name: "IX_GameRatings_PersonId",
                table: "GameRatings",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Mechanism_GamesId",
                table: "Mechanism",
                column: "GamesId");
